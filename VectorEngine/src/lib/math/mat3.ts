...
export const mat3 = {
    ...
    // Матрица поворота (Rotation) - угол в радианах
    ...
    // Комбинированная матрица из трансформаций
    fromTransform(
        tx: number, ty: number,
        rotationRad: number,
        sx: number, sy: number
    ...
    // Инверсия аффинной матрицы. Возвращает null если матрица вырожденная (det = 0)
